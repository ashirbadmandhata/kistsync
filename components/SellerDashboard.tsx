...
export default function SellerDashboard() {
  ...
  const seller = useQuery(api.seller.getByUserId, {
    userId: user?.id || "",
  });

  const createSeller = useMutation(api.seller.create);
  ...
  const isReadyToAcceptPayments = seller?.isActive;
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6">
          {/* Create Seller Account CTA */}
          {!seller && !accountCreatePending && isVerified && (
            <div className="text-center py-8">
              <h3 className="text-xl font-semibold mb-4">
                Start Accepting Payments
              </h3>
              <p className="text-gray-600 mb-6">
                Create your seller account to start receiving payments
              </p>
              <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="mt-2 flex items-center">
                    <div
                      className={`w-3 h-3 rounded-full mr-2 ${
                        seller.isActive ? "bg-green-500" : "bg-yellow-500"
                      }`}
                    />
                    <span className="text-lg font-semibold">
                      {seller.isActive ? "Active" : "Pending Setup"}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="mt-2 space-y-1">
                    <div className="flex items-center text-green-600">
                      ...
                      <span className="ml-2 text-black strong">Payments Enabled</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {!isVerified && (
            <div className="text-center py-8 text-red-600 font-medium">
              Please verify your email to access seller features.
            </div>
          )}
