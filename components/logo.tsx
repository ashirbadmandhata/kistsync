  ...
  return (
    <Link href="/" className="relative group">
      ...
      >
        ...
        >
          <span className="bg-gradient-to-r from-emerald-500 to-emerald-600 bg-clip-text text-transparent">Entry</span>
          <span className="bg-gradient-to-r from-blue-500 to-blue-600 bg-clip-text text-transparent">IQ</span>
        </motion.span>
      </motion.div>
    </Link>
  )
